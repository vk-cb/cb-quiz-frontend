...
const Header = () => {
  ...
  return (
    <div className='flex justify-between px-4 sm:px-16 h-20 items-center relative'>
        ...
        <div  className={`sm:flex absolute top-0 ${showSide ? "right-1 bg-gray-200 p-4 duration-300 rounded-bl-lg" : "-right-20 duration-300" }`}  >
          <button onClick={()=>setShowSide(!showSide)} className={`px-4 py-2 border border-orange-900 text-orange-900 text-sm font-medium rounded-lg mb-4 `}>close</button>
